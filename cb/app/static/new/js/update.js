...
// 	if (global_column > 0) {
// 		var out_string = 'Вы уверены, что хотите покинуть страницу? Обновление не завершено (сейчас на '+global_column+'столбце), информация будет фрагментирована';
// 		return out_string
// 	}
// }
...
function launchTiles() {
	...
	setTimeout(function(){
		head.append('.....<span>0%</span>');
		head.removeClass("mdc-typography--headline4");
		head.addClass("mdc-typography--headline3");
		$(".info").slideUp(300);
	},300);
	setTimeout(function(){
		$("#upd").animate({padding: '30px 0 27px'},250);
