...
class Data111(models.Model):
	...
	cod_emitenta = models.CharField(db_column='КОД_ЭМИТEHТA', blank=True, null=False, default=None, max_length=100)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class Data_korp_kontrol(models.Model):
	...
	#1
	srok_dla_inspolnenia_1 = models.CharField(max_length=1000, null=True, blank=True)
	srok_dla_inspolnenia_1_3 = models.CharField(max_length=1000, null=True, blank=True)
	data_instechenia_sroka_inpolnenia_1 = models.CharField(max_length=1000, null=True, blank=True)
	data_instechenia_sroka_inpolnenia_1_3 = models.CharField(max_length=1000, null=True, blank=True)
	otvet_1_2 = models.CharField(max_length=1000, null=True, blank=True)
	otvet_1_3 = models.CharField(max_length=1000, null=True, blank=True)
	otvet_3_3 = models.CharField(max_length=1000, null=True, blank=True)
	data_otveta_1_2 = models.CharField(max_length=1000, blank=True, null=True)
	data_otveta_1_3 = models.CharField(max_length=1000, blank=True, null=True)
	data_otveta_3_3 = models.CharField(max_length=1000, blank=True, null=True)
	ispolneno_1 = models.CharField(max_length=1000, null=True, blank=True)
	ispolneno_1_2 = models.CharField(max_length=1000, null=True, blank=True)
	ispolneno_1_3 = models.CharField(max_length=1000, null=True, blank=True)
	ispolneno_3_3 = models.CharField(max_length=1000, null=True, blank=True)
	...
	#1
	polucheno_1_2_bool = models.NullBooleanField(default=False, blank=True, null=True)
	polucheno_1_3_bool = models.NullBooleanField(default=False, blank=True, null=True)
	...
	zapros_o_predostavlenii_informacii = models.NullBooleanField(default=False, blank=True, null=True)
	predpisanie_ob_istrebovanii_documentov = models.NullBooleanField(default=False, blank=True, null=True)
	prepsanie_ob_ustranenii_narusheniya_zakonodatelstva_RF = models.NullBooleanField(default=False, blank=True, null=True)
	informaciaya_o_gosah_s_saitov_raskritiya_informacii = models.NullBooleanField(default=False, blank=True, null=True)
	zapros_o_predostavlenii_informacii_3_2 = models.NullBooleanField(default=False, blank=True, null=True)
	predpisanie_ob_istrebovanii_documentov_3_3 = models.NullBooleanField(default=False, blank=True, null=True)
	
	#3
	data_provedinia_3_1_1 = models.CharField(max_length=1000, null=True, blank=True)
	data_sostavlenia_spiska_lich_imeushih_pravo_na_uchastie_v_gosa = models.CharField(max_length=1000, null=True, blank=True)
	data_sostavlenia_protokola_gosa = models.CharField(max_length=1000, null=True, blank=True)
	povestka_dnia_gosa = models.CharField(max_length=1000, null=True, blank=True)
	sroki_provedenia_gosa_po_ustavu = models.CharField(max_length=1000, null=True, blank=True)
	polucheno_3_3 = models.CharField(max_length=1000, null=True, blank=True)
	srok_dla_inspolnenia_3_3 = models.CharField(max_length=1000, null=True, blank=True)
	data_instechenia_sroka_inpolnenia_3_3 = models.CharField(max_length=1000, null=True, blank=True)
...
class History(models.Model):
    id = models.IntegerField(unique=True, blank=True, primary_key=True) 
    object_id = models.IntegerField(db_column='object_id',  blank=True)
    datetime = models.DateTimeField(db_column='datetime',  auto_now=False, auto_now_add=False)
    type_id = models.IntegerField(db_column='content_type_id',  blank=True)
